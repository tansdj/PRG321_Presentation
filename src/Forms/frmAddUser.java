...
public class frmAddUser extends javax.swing.JFrame {
    ...
    private void btnInsertUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertUserActionPerformed
        ...
        try 
        {
            ...
            contactCell =  (String)txtCellphone.getText();
            ...
            {
                userToUpdate = new User(selectedPerson, selectedUser.getUsername(), selectedUser.getPassword(), selectedUser.getAccessLevel(), txtStatus.getText());
                userToUpdate.update();
            }
        } 
        catch (Exception e) 
