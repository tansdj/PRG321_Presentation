...
public class frmRegisterUserLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setName("registerUserLoginFrame"); // NOI18N
        setResizable(false);
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        try 
        {
            ...
            accessLevel = cmbAccessLevel.getSelectedItem().toString();
        ...
        {   
            ...
            department = new Department(dataClass.getUserDept());
            contact = new Contact(dataClass.getContactCell(), dataClass.getContactEmail());
            address = new Address(dataClass.getAddressLine1(), dataClass.getAddressLine2(), dataClass.getAddressCity(), String.valueOf(dataClass.getAddressPostal()));
            person = new Person(dataClass.getUserFirstName(), dataClass.getUserLastName(), dataClass.getUserID(), address, contact, department, dataClass.getUserCampus());            
            userToInsert = new User(person, txtUsername.getText(), txtPassword.getText(), cmbAccessLevel.getSelectedItem().toString(), txtStatus.getText());
            secQuestion = new SecurityQuestions(cmbQuestion.getSelectedItem().toString());
            userSec = new UserSecurityQuestions(userToInsert, secQuestion, txtAnswer.getText());
