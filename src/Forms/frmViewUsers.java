...
public class frmViewUsers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblViewUser.setFont(new java.awt.Font("Century Gothic", 1, 24)); // NOI18N
        lblViewUser.setForeground(new java.awt.Color(255, 255, 255));
        lblViewUser.setText("View User");
        lblViewUser.setAlignmentY(0.0F);
        ...
        lbxUsers.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                lbxUsersFocusGained(evt);
            }
        });
        ...
        txtCellphone.setFont(new java.awt.Font("Century Gothic", 0, 16)); // NOI18N
        txtCellphone.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
                        ...
                        .addGroup(pnlAddressInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnlAddressInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlAddressInfoLayout.createSequentialGroup()
                                    ...
                                    .addGap(65, 65, 65)
                                    .addComponent(txtCellphone, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(pnlAddressInfoLayout.createSequentialGroup()
                        .addGap(28, 28, 28)
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        {
            lbxUsers.setModel((ListModel<String>) userList);
            lbxUsers.setListData((String[]) userList.toArray());
        }
    }//GEN-LAST:event_formWindowActivated

    private void lbxUsersFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_lbxUsersFocusGained
        // TODO add your handling code here:
        User selectedUser = (User) lbxUsers.getModel();
        Person person = selectedUser.getPerson();
        Address address = person.getAddress();
        Contact contact = person.getContact();
        UserSecurityQuestions userSecQ = new UserSecurityQuestions();
        SecurityQuestions secQuestion = userSecQ.getQuestion();
//        String secQuestion = userSecQ.getQuestion();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmViewUsers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
